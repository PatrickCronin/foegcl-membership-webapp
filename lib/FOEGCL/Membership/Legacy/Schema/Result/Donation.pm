use utf8;
package FOEGCL::Membership::Legacy::Schema::Result::Donation;
...
FOEGCL::Membership::Legacy::Schema::Result::Donation - Year has a validation rule that needs to be updated yearly.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bYzNi1sTN+rPhw9zrKrhug
