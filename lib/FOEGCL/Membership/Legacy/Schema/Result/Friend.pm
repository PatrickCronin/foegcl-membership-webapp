use utf8;
package FOEGCL::Membership::Legacy::Schema::Result::Friend;
...
Related object: L<FOEGCL::Membership::Legacy::Schema::Result::CityStateZip>

=cut

__PACKAGE__->belongs_to(
  "city_state_zip",
  "FOEGCL::Membership::Legacy::Schema::Result::CityStateZip",
...
Related object: L<FOEGCL::Membership::Legacy::Schema::Result::ContactInfo>
...
Related object: L<FOEGCL::Membership::Legacy::Schema::Result::Donation>

=cut

__PACKAGE__->has_many(
  "donations",
  "FOEGCL::Membership::Legacy::Schema::Result::Donation",
  { "foreign.FriendID" => "self.FriendID" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EGgOMz8OI2rFsGTa3uJBRQ
