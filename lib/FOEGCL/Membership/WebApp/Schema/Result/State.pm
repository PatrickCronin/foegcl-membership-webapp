use utf8;
package FOEGCL::Membership::WebApp::Schema::Result::State;
...
__PACKAGE__->add_unique_constraint("state_state_name_key", ["state_name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZO6C0TCsdN/GVUM/QflXAA
