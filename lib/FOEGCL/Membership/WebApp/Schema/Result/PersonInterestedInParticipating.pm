use utf8;
package FOEGCL::Membership::WebApp::Schema::Result::PersonInterestedInParticipating;
...
Related object: L<FOEGCL::Membership::WebApp::Schema::Result::ParticipationRole>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tPrsqLv+ryrMbYQ5pKvS8Q
