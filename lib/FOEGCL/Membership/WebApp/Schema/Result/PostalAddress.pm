use utf8;
package FOEGCL::Membership::WebApp::Schema::Result::PostalAddress;
...
=head1 TABLE: C<postal_address>

=cut

__PACKAGE__->table("postal_address");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Q947cKT8WvFNl3SvbMb46g
