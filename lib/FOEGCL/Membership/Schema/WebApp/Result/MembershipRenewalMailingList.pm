#<<<
use utf8;
package FOEGCL::Membership::Schema::WebApp::Result::MembershipRenewalMailingList;
...
FOEGCL::Membership::Schema::WebApp::Result::MembershipRenewalMailingList
...
=head1 TABLE: C<membership_renewal_mailing_list>
